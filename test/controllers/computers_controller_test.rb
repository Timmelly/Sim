...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { ip: @computer.ip, mac: @computer.mac, name: @computer.name } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { ip: @computer.ip, mac: @computer.mac, name: @computer.name } }
